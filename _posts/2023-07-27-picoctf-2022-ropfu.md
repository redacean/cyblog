...
categories: [ 2022 Writeups, picoCTF 2022 ]
tags: [ pwn, binary exploitation, return oriented programming, buffer overflow, overflow, writeup ]
img_path: /assets/2023-07-27-picoctf-2022-ropfu/
---
...
_Finding the Return Address Offset with GDB and Peda_
...
_`vuln` Function Stack from Ghidra_
